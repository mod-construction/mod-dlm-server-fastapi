...
class ElementCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "boundingBox", "images", "buildingSystem", "productCategory", "material", "dimensional", "structuralProperties", "performance", "sustainability", "documentationAndCompliance", "installationAndConnectivity", "lifecycleAndMaintenance", "aestheticAndCustomizationOptions", "economicFactors"]
