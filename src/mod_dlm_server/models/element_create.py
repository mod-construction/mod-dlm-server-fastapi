...
class ElementCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "boundingBox", "images", "productCategory", "material", "dimensional", "structuralProperties", "performance", "sustainability", "documentationAndCompliance", "installationAndConnectivity", "lifecycleAndMaintenance", "aestheticAndCustomizationOptions", "economicFactors"]
