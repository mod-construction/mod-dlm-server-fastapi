...
class PrefabElementProductCategory(BaseModel):
    """
    Product category classification (e.g., Wall Panels, Stairs, Facade Elements).
    """ # noqa: E501
    category: StrictStr = Field(description="Specific product category within building systems.")
    building_system: StrictStr = Field(description="Building system category to which the product element belongs.", alias="buildingSystem")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PrefabElementProductCategory from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PrefabElementProductCategory from a dict"""
        if obj is None:
            return None
