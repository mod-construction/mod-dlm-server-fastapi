...
from mod_dlm_server.models.product_category import ProductCategory
try:
...
class PrefabElement(BaseModel):
    ...
    images: Annotated[List[StrictStr], Field(min_length=1)]
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "boundingBox", "images", "productCategory", "material", "dimensional", "structuralProperties", "performance", "sustainability", "documentationAndCompliance", "installationAndConnectivity", "lifecycleAndMaintenance", "aestheticAndCustomizationOptions", "economicFactors"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "productCategory": ProductCategory.from_dict(obj.get("productCategory")) if obj.get("productCategory") is not None else None,
